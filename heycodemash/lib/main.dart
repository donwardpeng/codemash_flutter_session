...
class _MyHomePageState extends State<MyHomePage> {
  ...
  final List<Image> _itemImages = [
    Image.asset('images/mighty_lion.jpg'),
    Image.asset('images/disapproving_gorilla.jpg'),
  ];

  // Set up a list to hold the images currently on the screen
  List<Image> _listOfImagesForScreen = [];

  // Declare an index for the image to display
  int _index = 0;
